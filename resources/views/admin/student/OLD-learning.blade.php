...
@extends('admin.layouts.main')
 @section('content')
    <!-- Container fluid -->
    <section class="py-4 py-lg-6 bg-green">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div>
                        <h2 class="color-blue mb-1 display-5 fw-bold"> Rivao Luke: <span class="text-dark">Learning Information</span></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-lb-tab mb-6" id="tab" role="tablist">
                        <li class="nav-item ms-0" role="presentation">
                            <a class="nav-link active" id="all-courses-tab" data-bs-toggle="pill" href="#all-courses" role="tab" aria-controls="all-courses" aria-selected="false" tabindex="-1">Buy Courses</a>
                        </li>
                    ...
                    <div class="tab-content" id="tabContent">
                        ...
                        <div class="tab-pane fade active show" id="all-courses" role="tabpanel" aria-labelledby="all-courses-tab">
                            <div class="row gap-3">
                        ...
                        <div class="tab-pane fade " id="shopping-cart" role="tabpanel" aria-labelledby="shopping-cart-tab">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <!-- Card -->
                                    <div class="card card-hover">
