                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="middle Name" id="middleName" value="{{$Name[1]}}" name="middle_name"  required>
                                    <div class="invalid-feedback" id="middle_name_error">Please enter your middle name.</div>
                                </div>
                                <!-- input -->
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="lastName">Last Name  <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Last Name" id="lastName" value="{{$Name[2]}}" name="last_name"   required>
