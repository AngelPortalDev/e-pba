                                                ...
                                                <td>
                                                    <a href="course-edit" class="text-inherit">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <h4 class="mb-1 text-primary-hover">Diploma of Arts in Human Resource Management</h4>
                                                                <span>Added on 7 July, 2023</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td><span class="badge bg-info-soft">Diploma</span></td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>
                                                    <a href="course-edit" class="text-inherit">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <h4 class="mb-1 text-primary-hover">Diploma in Recruitment and Employee Selection</h4>
                                                                <span>Added on 7 July, 2023</span>
                                                            </div>
                                                        </div>
                                                    </a>
