        ...
        <div class="row justify-content-between ">
                    ...
                    <div class="mb-2 mb-lg-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Reflective Journals</a></li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-lg-8 col-12 text-end pt-2">
                <div class="d-sm-flex justify-content-sm-end">
                        ...
                        <a href="add-reflective-journals"><button type="button" class="btn btn-primary">
                            Create <i class="fe fe-plus ms-1"></i>
                        </button></a>
                        </div> --}}
                        <div class="d-grid d-sm-block ms-2 d-md-0 mt-2 mt-md-0">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reflectiveJournals">
                            Create <i class="fe fe-plus ms-1"></i>
                        </button>
                        </div>
                        {{-- <div class="d-grid d-sm-block ms-2 d-md-0 mt-2 mt-md-0">
                                    ...
                                    <table class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox table-centered table-hover contentList w-100">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th>Sr. No.</th>
                                                <th>Reflective Journals Title</th>
...
<div class="modal fade" id="reflectiveJournals" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taskModalLabel">Create Reflective Journals</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                     <form class="row needs-validation"  id="addReflectiveJournalsData" novalidate>
                    <div class="mb-4 col-12">
                        ...
                        <div class="invalid-feedback" id="reflective_journals_award_error">Please select award</div>
                    </div>

                    <div class="mb-2 col-12">
                        <label for="reflectiveJournals" class="form-label">Reflective Journals <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="reflective_journals_title" id="reflective_journals_title" placeholder="Reflective Journals Title" required>
                        <small class="mt-1">Reflective journal title must be between 3 to 255 characters.</small>
                        <div class="invalid-feedback" id="reflective_journals_title_error">Please enter reflective journals title</div>
                    </div>

                    <div class="col-12 d-flex justify-content-end pt-2">
                        <button type="button" class="btn btn-primary me-2" id="addReflectiveJournals">Add</button>
...
<script>
    $(document).ready(function () {
        ...
        function list(action='') {
            ...
            $.ajax({
                url: baseUrl + "admin/reflective-journal-data/"+condition,
                method: "GET",
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                render: function (data,row) {
                                    ...
                                    var editUrl =
                                        baseUrl +
                                        "admin/reflective-journal-data-edit/" +
                                        action +
                                        "/" +
                                        assignId;
                                    return (
                            ...
                            },
                            {
                                ...
                                render: function (row) {
                                    ...
                                    return (
                                        ...
                                        editUrl +
                                        '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deleteReflectiveJournal" data-assign_id="'+assignId+'" data-course_id="'+courseId+'" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                    );
                                },
                            },
                        ],
    ...
    $('#reflectiveJournals').on('shown.bs.modal', function () {
    $('#award_id').select2({
        dropdownParent: $('#reflectiveJournals'),
