...
@section('content')
                    ...
                    <div class="mb-2 mb-lg-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Final Thesis</a></li>
                ...
                <div class="d-sm-flex justify-content-sm-end">
                    ...
                    <div class="d-grid d-sm-block ms-2 d-md-0 mt-2 mt-md-0">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#finalThesisModal">
                        ...
                        <div class="tab-content" id="tabContent">
                            ...
                            <div class="tab-pane fade active show" id="all-students" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table
                                        class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox table-centered table-hover w-100 contentList">
    ...
    <div class="modal fade" id="finalThesisModal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="taskModalLabel">Create Final Thesis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row needs-validation final_thesis-section" id="addFinalThesisData" novalidate class="">
                        ...
                        <div class="mb-2 col-12">
                            <label for="title" class="form-label">Final Thesis Title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="title"
                                id="title" placeholder="Final Thesis Title" required>
                            <small>Final thesis title must be between 3 to 255 characters.</small>
                            <div class="invalid-feedback" id="title_error">Please enter final thesis title
                            </div>
                        </div>

                        <div class="col-12 d-flex justify-content-end pt-2">
                            <button type="button" class="btn btn-primary me-2" id="addFinalThesis">Add</button>
...
<script>
    $(document).ready(function () {
        ...
        function list(action='') {
            ...
            $.ajax({
                url: baseUrl + "admin/final-thesis-data/"+condition,
                method: "GET",
                            ...
                            },
                            {
                                ...
                                render: function (row) {
                                    ...
                                    return (
                                        ...
                                        editUrl +
                                        '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deleteFinalThesis" data-assign_id="'+assignId+'" data-course_id="'+courseId+'" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                    );
                                },
                            },
                        ],
    ...
    $('#finalThesisModal').on('shown.bs.modal', function () {
    $('#award_id').select2({
        dropdownParent: $('#finalThesisModal'),
