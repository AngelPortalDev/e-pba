...
@section('content')
                    ...
                    <div class="mb-2 mb-lg-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Vlog</a></li>
                        ...
                        <div class="d-flex align-items-center col-12 col-md-5 col-lg-5 justify-content-end border-bottom">
                            <div class="row justify-content-end">
                                <form
                                    ...
                                    <input type="search" class="form-control ps-6 searchVlog" id="searchInput"
                        ...
                        <div class="tab-content" id="tabContent">
                            ...
                            <div class="tab-pane fade active show" id="all-students" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <!-- Table -->
                                    <table
                                        class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox table-centered table-hover contentList"
                                        style="width: 100%">
    ...
    <div class="modal fade" id="vlogModal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="taskModalLabel">Create Vlog</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row needs-validation vlog-section" id="addVlogData" novalidate class="">
                        ...
                        <div class="mb-4 col-12">
                            ...
                            <div class="invalid-feedback" id="vlog_award_error">Please select award</div>
                        </div>

                        <div class="mb-2 col-12">
                            <label for="VlogTitle" class="form-label">Vlog Title <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="vlog_title" id="vlog_title"
                                placeholder="Vlog Title" required>
                            <small class="mt-1">Vlog title must be between 3 to 255 characters.</small>
                            <div class="invalid-feedback" id="vlog_title_error">Please enter vlog title
                            </div>
                        </div>

                        <div class="col-12 d-flex justify-content-end pt-2">
                            <button type="button" class="btn btn-primary me-2" id="addVlogInter">Add</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            function list(action = '') {
                ...
                $.ajax({
                    url: baseUrl + "admin/vlog-data/" + condition,
                    method: "GET",
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data) {
                                        var course_title = data['award_course'] && data[
                                                'award_course']['course_title'] !=
                                            null ? data['award_course'][
                                            'course_title'] : '';
                                        return (
                                ...
                                },
                                {
                                    ...
                                    render: function(row) {
                                        ...
                                        return (
                                            ...
                                            editUrl +
                                            '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deleteVlog" data-assign_id="' +
                                            assignId + '" data-course_id="' +
                                            courseId +
                                            '" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                        );
                                    },
                                    width: "10%"
                                },
        ...
        $('.searchVlog').on('keyup', function() {
            var table = $('.contentList').DataTable();
            var searchTerm = $(this).val();
            table.search(searchTerm).draw();
        });
        $('#vlogModal').on('shown.bs.modal', function () {
            $('#award_id').select2({
                dropdownParent: $('#vlogModal'),
