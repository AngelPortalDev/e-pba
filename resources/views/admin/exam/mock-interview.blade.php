                    ...
                    <div class="mb-2 mb-lg-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Mock Interview</a></li>
                ...
                <div class="col-lg-8 col-12 text-end pt-2">
                    <div class="d-sm-flex justify-content-sm-end">
                          ...
                          <div class="d-grid d-sm-block ms-2 d-md-0 mt-2 mt-md-0">
                            <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addMockInterview">
                        ...
                        <div class="card-header p-0 col-12 col-md-7 col-lg-7">
                            <ul class="nav nav-lb-tab border-bottom-0" id="tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active list-tab" data-cat="All" data-bs-toggle="pill" href="#all-sections" role="tab"  aria-selected="true">All</a>
                                </li>

                                <li class="nav-item" role="presentation">
                                    {{-- <a class="nav-link list-tab" data-cat="Yes" data-bs-toggle="pill" href="#all-sections" role="tab"  aria-selected="true">Delete</a> --}}
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                                    <a class="nav-link list-tab" data-cat="No" data-bs-toggle="pill" href="#all-sections" role="tab"  aria-selected="true">Inactive</a>
                                </li> --}}
                            </ul>
                        </div>
                        ...
                        <div class="d-flex align-items-center col-12 col-md-5 col-lg-5 justify-content-end border-bottom">
                            <div class="row justify-content-end">
                                <form class="d-flex align-items-center col-lg-8 col-md-12 col-sm-12 mt-2 mt-md-0 mb-2 mb-md-0 w-100">
                                    ...
                                    <input type="search" class="form-control ps-6 searchMock" id="searchInput" placeholder="Search Here">
                                </form>
...
<div class="modal fade" id="addMockInterview" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taskModalLabel">Create Mock Interview</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                     <form class="row needs-validation"  id="addMockData" novalidate>
                    ...
                    <div class="mb-2 col-12">
                        <label for="MockInterviewTitle" class="form-label">Mock Interview Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="mockinterview_tittle" id="mockinterview_tittle" placeholder="Mock Interview Title" required>
                        <small>Mock Interview title must be between 3 to 255 characters.</small>
                        <div class="invalid-feedback" id="interview_tittle_error">Please enter mock interview title</div>
                    </div>
...
<script>
    $(document).ready(function () {
        // Initialize the DataTable with default action
        list(btoa('All'));

        // Handle search input to filter the DataTable
        handleSearchInput('searchInput', function() {
            list(btoa('All')); // Reload with default filter on clear
        });

        // Tab click event to filter data based on category
    ...
    function list(action='') {
        ...
        $.ajax({
            url: baseUrl + "admin/list-data/"+condition,
            method: "GET",
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data,row) {
                                ...
                                var courseId = btoa(data.award_id);

                                var action = btoa("edit");
                                var editUrl =
                                    baseUrl +
                                    "admin/mock-data-edit/" +
                                    action +
                                    "/" +
                                    assignId;
                                return (
                        ...
                        // },
                        {
                            ...
                            render: function (row) {
                                ...
                                return (
                                    ...
                                    editUrl +
                                    '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deleteMock" data-assign_id="'+assignId+'" data-course_id="'+courseId+'" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                );
                            },
                        },
    ...
    $('.searchMock').on('keyup', function() {
        var table = $('.contentList').DataTable();
        var searchTerm = $(this).val();
        table.search(searchTerm).draw();
    });

    $('#addMockInterview').on('shown.bs.modal', function () {
    $('#award_id').select2({
        dropdownParent: $('#addMockInterview'),
