...
@section('content')
    ...
    <section class="container-fluid p-4">
        <div class="row justify-content-between ">
            ...
            <div class="col-lg-8 col-12 text-end pt-2">
                <div class="d-sm-flex justify-content-sm-end">
                        ...
                        <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addMultipleChoice">
                            Create <i class="fe fe-plus ms-1"></i>
                        </button>
                        </div>
                        {{-- <div class="d-grid d-sm-block ms-2 d-md-0 mt-2 mt-md-0">
                        <button type="button" class="btn btn-outline-primary deleteMultipleChoice">
                        ...
                        <div class="d-flex align-items-center col-12 col-md-5 col-lg-5 justify-content-end border-bottom">
                            <div class="row justify-content-end">
                                <form class="d-flex align-items-center col-lg-8 col-md-12 col-sm-12 mt-2 mt-md-0 mb-2 mb-md-0 w-100">
                                    ...
                                    <input type="search" class="form-control ps-6 searchMcq" id="searchInput" placeholder="Search Here">
                                </form>
                                    ...
                                    <table class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox table-centered table-hover contentList w-100">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th>Sr. No.</th>
                                                <th>Multiple Choice Assessment Title</th>
       ...
       <!-- Create A Modal -->
<div class="modal fade" id="addMultipleChoice" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taskModalLabel">Create New Multiple Choice Assessment</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="row needs-validation multiplechoice-section"  id="multiplechoiceForm" novalidate class="">
                    <div class="mb-4 col-12">
                        ...
                        <div class="invalid-feedback" id="award_error">Please select award</div>
                    </div>

                    <div class="mb-2 col-12">
                        <label for="title" class="form-label">Multiple Choice Assessment Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="title" id="title" placeholder="Multiple Choice Assessment Title" required>
                        <small>The MCQ title must be between 3 to 255 characters</small>
                        <div class="invalid-feedback" id="title_error">Please enter multiple choice assessment title</div>
                    </div>

                    <div class="col-12 d-flex justify-content-end pt-2">
                        <button type="button" class="btn btn-primary me-2" id="addMcq" >Add</button>
...
<script>
    $(document).ready(function () {
        ...
        function list(action='') {
            ...
            $.ajax({
                url: baseUrl + "admin/mcq-data/"+condition,
                method: "GET",
                            ...
                            },
                            {
                                ...
                                render: function (row) {
                                    ...
                                    return (
                                        ...
                                        editUrl +
                                        '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deleteMcq" data-assign_id="'+assignId+'" data-course_id="'+courseId+'" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                    );
                                },
                            },
                        ],
    ...
    $('.searchMcq').on('keyup', function() {
        var table = $('.contentList').DataTable();
        var searchTerm = $(this).val();
        table.search(searchTerm).draw();
    });
    $('#addMultipleChoice').on('shown.bs.modal', function () {
    $('#award_id').select2({
        dropdownParent: $('#addMultipleChoice'),
