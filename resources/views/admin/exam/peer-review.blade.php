        ...
        <div class="row justify-content-between ">
                    ...
                    <div class="mb-2 mb-lg-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Peer Review</a></li>
            ...
            <div class="col-lg-8 col-12 text-end pt-2">
                <div class="d-sm-flex justify-content-sm-end">
                    ...
                    <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#peerreview">
                        ...
                        <div class="d-flex align-items-center col-12 col-md-5 col-lg-5 justify-content-end border-bottom">
                            <div class="row justify-content-end">
                                <form class="d-flex align-items-center col-lg-8 col-md-12 col-sm-12 mt-2 mt-md-0 mb-2 mb-md-0 w-100">
                                    ...
                                    <input type="search" class="form-control ps-6 searchPeerReview" id="searchInput" placeholder="Search Here">
                                </form>
...
<div class="modal fade" id="peerreview" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taskModalLabel">Create Peer Review</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="row needs-validation peerReview-section" id="addPeerReviewData" novalidate class="">
                    <div class="mb-4 col-12">
                        ...
                        <div class="invalid-feedback" id="peer_review_award_error">Please select award</div>
                    </div>

                    <div class="mb-2 col-12">
                        <label for="PeerReviewTitle" class="form-label">Peer Review Title <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="peer_review_title" id="peer_review_title" placeholder="Peer Review Title" required>
                        <small class="mt-1">Peer review title must be between 3 to 255 characters.</small>
                        <div class="invalid-feedback" id="peer_review_title_error">Please enter peer review title.</div>
                    </div>

                    <div class="col-12 d-flex justify-content-end pt-2">
                        <button type="button" class="btn btn-primary me-2" id="addPeerReview">Add</button>
...
<script>
    $(document).ready(function () {
        ...
        function list(action='') {
            ...
            $.ajax({
                url: baseUrl + "admin/peer-review-data/"+condition,
                method: "GET",
                            ...
                            },
                            {
                                ...
                                render: function (row) {
                                    ...
                                    return (
                                        ...
                                        editUrl +
                                        '" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fe fe-edit"></i></a><a href="javascript:void(0);"  class="deletePeerReview" data-assign_id="'+assignId+'" data-course_id="'+courseId+'" data-bs-toggle="tooltip" data-placement="top" title="Delete" ><i class="fe fe-trash"></i></a></div>'
                                    );
                                },
                            },
                        ],
    ...
    $('.searchPeerReview').on('keyup', function() {
        var table = $('.contentList').DataTable();
        var searchTerm = $(this).val();
        table.search(searchTerm).draw();
    });
    $('#peerreview').on('shown.bs.modal', function () {
    $('#award_id').select2({
        dropdownParent: $('#peerreview'),
