    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <img class="p-3 " src="{{ asset('frontend/images/email/document-rejected.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p> <strong>We regret to inform you that your document verification for enrollment at E-Ascencia has been rejected due to the following reasons: </strong></p>
                
                <p style="margin-bottom: 20px;"><strong>[Rejected Reason: #_________________________# ] </strong></p> 
                <p><strong>List of Rejected Documents:</strong></p>

                <h6 style="font-size: 15px;color: #2b3990"> <strong >1.	Identity Proof: <span style="color: #ff0000;">Rejected </span></strong></h6>
                {{-- <h6 class="mb-2" style="font-size: 15px;color: #2b3990"><strong> 2.	Education Proof: <span style="color: #ff0000;">Rejected </span></strong></h6> --}}

                <p>We understand this may be disappointing, but do not be discouraged. <strong style="color: #2b3990">You have #2attempt# more attempts to submit your documents.</strong> Please take a moment to review the reason for rejection and provide corrected documents for verification. </p>

                <p> If you believe there has been an error or if you need further clarification, please don't hesitate to contact us at <strong> <a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a> </strong> We're committed to helping you through this process.</p>
                
                <p>We appreciate your cooperation and understanding. Thank you for your attention to this matter.</p>


                <p class="mb-3"> Warm regards, <br>
