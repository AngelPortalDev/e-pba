    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                <h2 style="font-weight: 700;font-size: 24px; " class="my-2"> Congratulations on Reaching <br/><span style="color: #2b3990;"> 50% Course Completion!</span>
                </h2>
            </div>
            <div class="col-md-6">
                <img class="p-3 " src="{{ asset('frontend/images/email/course_complete.png') }}" alt="E-Ascencia"
                    width="100%">
            </div>
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><strong> Congratulations! You have completed 50% of your course on E-Ascencia.Your dedication is inspiring, and your progress is impressive! Keep up the great learning! </strong></p>

                <p>We would love to hear your thoughts and feedback. Please take a moment to complete our brief feedback form by clicking <strong>[Feedback Form Link]. </strong> Your responses will help us understand what's working well and where we can improve.</p>
                
                 <p> Once you finish the course, you will receive a certificate to celebrate your achievement and dedication.</p>
                 <p class="fw-bold">Thank you for choosing E-Ascencia. We're here to support you all the way.</p>
                 <p>Happy learning!</p>
