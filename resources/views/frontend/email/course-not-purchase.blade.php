    ...
    <div class="container" style="font-family: Tahoma;">
        <div class="row align-items-center justify-content-center">
            ...
            <div style="text-align: center;">
                <p style="font-weight: 700;font-size: 24px; " class="my-2 text-color subject1">Don't Miss Out on <br/> Your Learning Journey with  
                    <span style="color: #2b3990;"> E-Ascencia! </span></p>

            </div>
            <div style="text-align: center;">
                <img class="p-3 coursereminderIcon" src="https://www.eascencia.mt/frontend/images/email/course-not-purchase.png" alt="E-Ascencia" style="width:50%; padding:10px">
            </div>
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><strong>We noticed that you registered on E-Ascencia but haven't enrolled in a course yet.</strong> Our wide range of courses is designed to help you achieve your learning goals. <span style="color: #2b3990; font-weight: bold">Don't miss out—take the next step today!</span></p>
              
                 <p> To enroll, log into your account, browse our course catalog, and select the course that interests you. If you have any questions or need help, feel free to contact us at <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt</a></strong><br>
                    We look forward to helping you on your educational journey!</p>
