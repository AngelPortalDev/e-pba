    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <h3 style="font-weight: 700;; font-size: 24px" class="mb-2 text-dark">Your
                    <span style="color: #2b3990">E-ascencia </span> <br/> Password Has Been Reset
                </h3>

            </div>
            <div class="col-md-8">

                <img class="p-3 " src="{{ asset('frontend/images/email/password-update-01.png') }}" alt="E-Ascencia"
                    width="100%">
            </div>
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p> 
                    <strong style="color: #2b3990">We wanted to let you know that your Password has been successfully reset.</strong>
                    <span>With your new credentials, you can now access your E-Ascencia account.</span>
                </p>
                <p class="text-dark fw-bold">To log in, please visit [Web Link] and use the following credentials:</p>
                <p style="font-size: 15px;color: #2b3990;"> <strong>Username: users@gmail.com </strong><br> 
                    <strong>Password: XXXXXXXX </strong></p>
                <p> If you did not request this password reset or have any concerns, please contact us immediately at  <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a> </strong>or reach out through our live chat support. </p>
                <p>We’re here to help you continue your learning journey smoothly!</p>
