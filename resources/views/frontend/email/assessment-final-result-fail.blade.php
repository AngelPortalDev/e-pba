...
<body>
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                    ...
                    <hr>
                    <div class="col-md-12">
                        <h3 class="mb-2 text-center assessmentFailHeading">
                            <span class="text-dark">Assessment Failed </span> <br/> Module Locked, Purchase Required to Regain Access
                        </h3>
                        {{-- <img class="p-3 " src="{{ asset('frontend/images/email/FAIL-Assessment-Result.png')}}" alt="E-Ascencia" width="100%"> --}}
                        <img class="p-3 " src="{{ asset('frontend/images/email/FAIL-Assessment-Result.png')}}" alt="E-Ascencia" width="100%">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                        ...
                        {{-- <h4 style="font-weight: 700;color: #2b3990 " class="mb-3">
                        ...
                        <p> I hope this message finds you well. </p>
                            ...
                            <p><strong>We regret to inform you that you did not pass your recent assessment. Additionally, you have exhausted both attempts to retake the test for this module. As a result, access to the module has been locked.</strong></p>    
                            <p>To access the module and continue learning, you must purchase the course again. 
                                If you have any questions or need assistance with the process, please feel free to contact us at <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a> </strong></p>
                            <p>We are here to support you in achieving your academic goals.</p>
                            <p>We appreciate your understanding and wish you the best as you continue your learning journey.</p>
