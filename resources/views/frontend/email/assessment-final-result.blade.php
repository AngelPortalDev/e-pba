    ...
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                        ...
                        <p>
                            Dear #Name#, <br></p>
                        <p> For this assessment, your grade is as follows:: </p>

                                <h6>1. Course Name: #[Course Name]#</h6>	
                                <h6>2.	Result: <span style="color:red">Fail</span></h6>
                                
                                <p>Although you did not pass this time, we want to acknowledge your hard work and encourage you to keep striving. Every step, including setbacks, is a valuable part of the learning journey.</p>
                            ...
                            <strong>Keep going, and don't give up!</strong></p>
