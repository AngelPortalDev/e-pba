    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <img class="p-3 " src="{{ asset('frontend/images/email/document-sent-for-approval.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><span class="fw-bold">Thank you for submitting your #[Identity/Educational]# document. We have forwarded them to our administrative team for thorough review and approval. </span><strong>The review process typically takes between 1-2 business days.</strong>  We will notify you once the review is complete.</p>

                <p> If you have any questions or require further assistance, please contact us at 
                    <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a></strong> Your patience is sincerely appreciated.</p>
