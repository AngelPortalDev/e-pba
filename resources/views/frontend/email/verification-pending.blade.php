        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div style="text-align: center;">
                <p style="font-weight: 700;" class="mb-2 text-color subject-small">
                    New Institute Submission Pending Verification
                </p>
            ...
            <div style="text-align: center;">
                ...
                <img class="p-2 documentVerification" src="{{ asset('frontend/images/email/documnet-verification.png') }}" alt="E-Ascencia" style="width:50%; padding:10px">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p class="text-color"> <strong>A new institute has submitted its registration details and is pending verification.</strong></p>


                <p class="text-color"> Please review the submitted information and proceed to approve or reject the request as appropriate.</p>

                <p class="text-color"> Once approved, the institute will receive login access.</p>
