    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <img class="p-3 " src="{{ asset('frontend/images/email/reset-password-link.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><strong>We received a request to reset your password. Click the link below to reset it:</strong></p>

              <p><a href="#" style="overflow-wrap: break-word;" target="_blank">https://www.eascencia.mt/reset-password/c465be84617e3b8528242a582d22a4caea2bb5c72246a9d401e53ca8c81b0479?email=chetan%40angel-portal.com</a></p> 
