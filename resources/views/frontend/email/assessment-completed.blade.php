    ...
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-8">
                        ...
                        <img class="p-3 " src="{{ asset('frontend/images/email/Assessment-Completed.png')}}" alt="E-Ascencia" width="100%">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                        ...
                        <h4 style="font-weight: 700;color: #2b3990 " class="mb-3">
                            Congratulations! Assessment submitted successfully!
                        </h4>
                
                        <p> Dear John Doe, <br></p>
                        <p><strong>Congratulations on submitting your assessment!</strong> </p>
                        <p> Your dedication to learning is commendable. We understand the anticipation of awaiting results, and we assure you that they will be available soon.</p>

                       
                            <p>In the meantime, if you have any questions or need assistance, feel free to reach out to us at <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a></strong> We're here to support you every step of the way. <br> </p>
                            <p>Thank you for choosing E-Ascencia for your online education journey!</p>
