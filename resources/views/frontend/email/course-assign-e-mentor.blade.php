...
<body>
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                    ...
                    <hr>
                    <h4 style="font-weight: 700;color: #2b3990 " class="mb-3 text-center">
                        New Course Assignment Notification
                    </h4>
            
                    <div class="col-md-7">

                        <img class="p-3 " src="{{ asset('frontend/images/email/E-mentor.png')}}" alt="E-Ascencia" width="100%">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                        ...
                        <p>
                             Dear [E-mentor’s Name], <br></p>
                        <p><strong>We are pleased to inform you that a new course has been assigned to you on the E-Ascencia platform. Below are the details of the course:</strong> </p>

                        <p><strong>Course Details:</strong></p>
                        <ol>
                            <li><p class="mb-0"> <strong>Course Name:</strong> [Course Name]</p></li>
                            <li><p class="mb-0"><strong>Assigned Date:</strong> [Assigned Date]</p></li>
                            <li><p class="mb-0"><strong>Course Duration: </strong> [Course Duration]</p></li>
                          </ol>
                                
                                <p>As the assigned e-mentor for this course, your role is crucial in guiding and supporting students throughout their learning journey. Please ensure that you check the course content and are available for any student queries.</p>

                        </p>
                            <p>Thank you for your dedication and commitment to providing quality education.</p>
