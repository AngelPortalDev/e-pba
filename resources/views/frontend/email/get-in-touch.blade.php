        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div style="text-align: center;">
                ...
                <p style="font-weight: 700;" class="mb-2 text-color subject-small">
                    Thank You for Contacting <span style="color: #2b3990">E-Ascencia!</span> <br/> Let's Get Started!
                </p>
            ...
            <div style="text-align: center;">
                ...
                <img class="p-2 contactusIcon" src="https://www.eascencia.mt/frontend/images/email/contact-us.png" alt="E-Ascencia" style="width:60%; padding:10px">

            </div>

            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">

                <p class="text-color">Dear #Visitor Name#, </p>

                <p class="text-color"><strong><span style="color: #2b3990">Thank you for reaching out to E-Ascencia!</span>  We are excited to connect with you and explore how we can support your educational or professional journey. </strong></p>

                <p class="text-color"> One of our team members will be in touch shortly. In the meantime, feel free to explore our website and learn more about our wide range of opportunities.</p>
                

                <p class="text-color">We look forward to supporting you in achieving your academic success!</p>
