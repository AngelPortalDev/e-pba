    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <h3 style="font-weight: 700;color: #2b3990; font-size: 24px" class="mb-2">
                    <span class="text-dark">First attempt failed </span> <br/> Final chance to retake the assessment
                </h3>

            </div>
            <div class="col-md-8">

                <img class="p-3 " src="{{ asset('frontend/images/email/final_attempt_failed.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p> 
                    <strong>We regret to inform you that you did not pass the assessment on your first attempt. However, you have another opportunity to retake the assessment.</strong>
                    <span>Please ensure you complete this second attempt before 15 days after the end of the course duration.</span>
                </p>
                <p>We encourage you to review the material thoroughly and prepare for your retake.</p>
                <p> If you need any assistance or have questions, please feel free to contact us <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a> </strong>We are here to support you and help you succeed. </p>

                <p>Thank you for your attention. We wish you the best of luck on your upcoming assessment</p>
