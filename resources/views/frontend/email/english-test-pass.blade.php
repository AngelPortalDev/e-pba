        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <h4 style="font-weight: 700;" class="mb-2">
                    You Passed English Proficiency Test.
                </h4>
            ...
            <div class="col-md-6">
                ...
                <img class="p-2 " src="{{ asset('frontend/images/email/english-test-pass.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p> Congratulations on completing your <strong>English Language Proficiency Test </strong>on E-Ascencia! We are thrilled
                    to inform you that you have passed the test.</p>

                <p> <strong>Your Results:</strong></p>
                <h6 class="fw-bold">1. Score: <span class="text-success"> 29/30 </span></h6>
                <h6 class="fw-bold">2. Status: <span class="text-success"> [C1/ Advanced]</span></h6>

                <p> Your proficiency in English will greatly enhance your learning experience in our courses. You are
                    now all set to start your course and achieve your educational goals.</p>

                <p> If you have any questions or need further assistance, please contact us at
                    <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a></strong></p>
