        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <h3 style="font-weight: 700;color: #2b3990 " class="mb-2">
                    <span class="text-dark">Final Exam Attempt Unsuccessful</span> <br/> Refund Process Initiated
                </h3>
            </div>
            <div class="col-md-6">

                <img class="p-3 " src="{{ asset('frontend/images/email/english-final-result-fail.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><strong> We regret to inform you that you did not pass the exam on your second attempt, and both retake opportunities have now been exhausted. As a result, we will process a refund of your course fees, which will be completed within five working days.</strong></p>

                <p> If you have any questions or need assistance, please feel free to reach out at  <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a> </strong></p>
