        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div style="text-align: center;">
                <p style="font-weight: 700; color:#2b3990 !important;" class="mb-2 text-color subject-small">
                    Notification for Checking Student <br/><span style="color: #000 !important">Assignments via Turnitin </span>
                </p>

            </div>
            <div style="text-align: center;">

                <img class="p-2 documentVerification" src="{{ asset('frontend/images/email/notification-assignment.png') }}" alt="E-Ascencia" style="width:60%; padding:10px">
                
            </div>

            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">

                <p class="text-color">Dear Sadaf Ma’am, </p>
                <p class="text-color">I hope this message finds you well.</p>

                <p class="text-color">This is to notify you that the assignment submitted by the following student is ready for a plagiarism check using Turnitin:</p>

                <p>Student Name: <strong> [Student Name] </strong></p>
                <p>Course Name:  <strong> [Course Name] </strong></p>


                <p class="text-color">Kindly review the submission at your convenience.</p>
