    ...
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-12 text-center border-bottom pb-2 mb-4">
                    <img class="logo-1 mb-2" src="{{ asset('frontend/images/brand/logo/logo.png') }}" alt="E-Ascencia Logo">
                </div>

                <div class="col-md-12 text-center">
                    <h2 style="font-weight: 700;font-size: 28px; " class="my-2">&#127881; Welcome to 
                    ...
                    <div class="col-md-6  ">
                        ...
                        <img class="p-2 img-fluid" src="{{ asset('frontend/images/email/registration-successful_1.png')}}" alt="E-Ascencia">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start pt-1">
                        ...
                        <p> Dear #Name#, </p>
                        <p><strong style="color: #2b3990;"> Welcome to the E-Ascencia Web Portal!</strong> We are thrilled to have you join our online learning community. </p>
                        <p> <strong>Your login credentials are:</strong></p>
                            
                            <p style="font-size: 15px;color: #2b3990;"> <strong>Username: #Username#  </strong><br> 
                        ...
                        <p> To access your account, simply visit <a href="http://eascencia.mt/"><strong>https://eascencia.mt </strong></a> and log in using the above credentials. </p>
                        <p>If you have any questions or need assistance, feel free to reach out to us at  <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a></strong> or through our live chat support. </p>

                            <p><strong>Happy learning!</strong> </p>
                            <p>Best regards,<br> <strong>The E-Ascencia Team </strong></p>
