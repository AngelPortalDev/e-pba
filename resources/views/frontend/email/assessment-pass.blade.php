    ...
    <div class="container"> 
            <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-7">
                        ...
                        <img class="p-3 " src="{{ asset('frontend/images/email/PASS-Assessment-Result.png')}}" alt="E-Ascencia" width="100%">
                    ...
                    <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                        ...
                        <h4 style="font-weight: 700;color: #2b3990 " class="mb-3">
                            Well Done! Your Assessment Results!
                        </h4>
                
                        <p>
                            Dear #student_name#, <br></p>
                        <p><strong>Congratulations on passing your assessment!</strong> </p>
                        <p> Your grade is as follows: </p>

                                <h6 class="text-dark fw-bold">1. Course Name: <span style="color: #2b3990">[Course Name]</span></h6>	
                                <h6 class="text-dark fw-bold">2.	Result: <span style="color:green">Pass</span></h6>
                                <h6 class="text-dark fw-bold">3.	Your Score: <span style="color: #2b3990"> [Score/Grade] </span></h6>
                                <p>Your dedication and hard work have paid off, and we're delighted with your outstanding performance. </p>

                        </p>
                            <p>For any questions, feel free to contact our support team at <strong><a class="text-decoration-none text-dark" href="mailto:support@eascencia.mt">support@eascencia.mt.</a></strong> <br>
