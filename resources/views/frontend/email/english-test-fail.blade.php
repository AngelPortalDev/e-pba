        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 text-center">
                ...
                <h3 style="font-weight: 700;color: #2b3990 " class="mb-2">
                    ...
                    <span class="text-dark">First attempt failed </span> <br/> Final chance to retake the test
                </h3>

            </div>
            <div class="col-md-6">

                <img class="p-3 " src="{{ asset('frontend/images/email/english-test-fail.png') }}" alt="E-Ascencia"
                    width="100%">
            ...
            <div class="col-md-12 ps-md-4 my-md-3 border-md-start">
                ...
                <p><strong>We regret to inform you that you did not pass the English test on your first attempt. However, you have one last chance to retake English test.</strong> We encourage you to take this opportunity to review your preparation and give it your best effort.<span style="color: #2b3990; font-weight: bold" > You have 14 days from your course purchase date to make this attempt.</span></p>

                <p>If you have any questions or need assistance, please do not hesitate to contact us. We are here to support you in your learning journey.</p>

                <p>Thank you for your attention to this matter. We wish you luck on your next attempt.</p>
