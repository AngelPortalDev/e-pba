                                ...
                                <div class="card-header p-0 col-12 col-md-12 col-lg-12">
                                    <ul class="nav nav-lb-tab border-bottom-0" id="tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active section-courses-tab" data-cat="all" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">All</a>
                                        </li>
                                        {{-- <li class="nav-item" role="presentation">
                                            <a class="nav-link section-courses-tab" data-cat="athe" data-bs-toggle="pill" href="#all-courses-tab" role="tab" aria-selected="false" tabindex="-1">ATHE</a>
                                        </li> --}}
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="dba" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">DBA</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="masters" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Masters</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="diploma" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Diploma</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="certificate" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Certificate</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="award" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Award</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="athe5" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Athe Level 5</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="athe4" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Athe Level 4</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  section-courses-tab" data-cat="athe3" data-bs-toggle="pill" href="#all-courses-tab" role="tab"  aria-selected="true">Athe Level 3</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<script>
    ...
    $(".section-courses-tab").on("click", function () {
    ...
    function assignedCourseList(action){
        ...
        $.ajax({
            url: BaseUrl + '/ementor/e-mentor-courses-list/'+ action,
            method: 'GET',
            success: function(response) {
                if ($.fn.DataTable.isDataTable('.assignedCourseList')) {
                    $('.assignedCourseList').DataTable().destroy();
                }
