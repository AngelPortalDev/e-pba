            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="heading_section">
                        <p class="malta_heading_title">Earn your <span class="degreeText">Integrated Degree</span></p>
                        <p class="malta_sub_heading_top">
                            MBA + DBA
                        </p>
                        <p class="blended_program_style">BLENDED PROGRAM</p>
                    ...
                    <div class="study_benifits">
                        <ul class="list-unstyled study_benifi_list">
                            <li><i class="bi bi-check-circle"></i><span>Study Mode: Online</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Accreditation: MQF-EQF Level</span></li>
                            <li><i class="bi bi-check-circle"></i><span>European Degree</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Double Degree Advantage</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Flexible Payment Method</span></li>
                        </ul>

                        <div class="mt-5">
                            <p class="mb-1"><span class="mbadbaheading">MBA</span> <span>(1 year) </span></p>
                            <p class="mb-1 mbadbaprice">Official Price: 5000<i class="bi bi-currency-euro"></i></p>
                            <p class="mb-1" > <span class="scholarshiptext">(50% Scholarship) </span> <span class="scholarshipAmount"> 2500 <i class="bi bi-currency-euro"></i>/year </span></p>
                            <p><span class="installmentText">Pay in Installment: </span> <span class="installmentTextPrice"> 209<i class="bi bi-currency-euro"></i></span> (every month)</p>
                        </div><hr/>
                         <div>
                            <p class="mb-1"><span class="mbadbaheading">DBA</span> (3 years)</p>
                          
                            <p class="mb-1 mbadbaprice">Official Price: 10000<i class="bi bi-currency-euro"></i></p>
                            <p class="mb-1"> <span class="scholarshiptext">(50% Scholarship) <span class="scholarshipAmount"> 5000 <i class="bi bi-currency-euro"></i>/year </span></p>
                            <p> <span class="installmentText">Pay in Installment: </span> <span class="installmentTextPrice"> 417<i class="bi bi-currency-euro"></i></span> (every month)</p>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 malta_form_column">
                    <div class="malta_lead_form" id="apply-form">
                        ...
                        <iframe aria-label='Admission Open for 2025 Intake!' frameborder="0" style="height:1450px;width:100%;border:none; overflow-y: hidden;;" src='https://forms.zohopublic.com/info5253/form/AdmissionOpenfor2025Intake11/formperma/tvaqtD5y4uU5ZENSV7zV61kiue2JGARrAgO9ynhXs-o'></iframe>
                    </div>
                </div>
