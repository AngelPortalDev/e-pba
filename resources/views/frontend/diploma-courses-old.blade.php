        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="text-white mb-1 display-4 color-green">Diploma Courses</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-lg-8">
            ...
            <div class="row row-gap-3">
                {{-- <div class="col-md-4 col-sm-6 col-lg-3"> --}}
                    @php
                    $diploma =
                    getData('course_master',['course_title','id','selling_price','ects','course_final_price','course_old_price','course_thumbnail_file','status','temp_count'],['category_id'=>'3'],'',DB::raw('IFNULL(published_on, "NULL")'),'asc');
                                            ...
                                            {{-- <div class="col-auto">
                                                @if (Auth::check() && Auth::user()->role =='user')
                                                    ...
                                                    @if (isset($isPaid) && !empty($isPaid) && is_numeric($isPaid) &&  $isPaid > 0)
                                                        ...
                                                        @else
                                                            <a href="#" id="learningVerified" class="text-inherit"><i class="fe fe-play btn-outline-primary "></i>Play</a>
                                                        @endif
                                                        @else
                                                        <div class="d-flex">
                    ...
                    @endforeach
                    @else
                    <img src="{{ asset('frontend/images/ComingSoon.png') }}" alt="diploma" style="width:auto;height:auto" loading="lazy">
                    @endif
                    <!-- Card -->
                    {{-- <div class="card card-hover">
                        <a href="#"><img
                                src="{{ asset('frontend/images/course/diploma-human-resource-management.png') }}"
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="mb-2 text-truncate-line-2 course-title"><a
                                    href="#" class="text-inherit">Post Graduate Diploma
                                    in Human Resource Management</a></h4> --}}
