...
@php
    ...
    $CourseWatchDatas = getData('student_course_master',['watch_content_id','course_progress','course_expired_on','id','total_course_price','payment_installment_type'],['user_id'=>Auth::user()->id,'course_id'=>$CourseId],'','id','DESC');
    ...
    if($CourseWatchDatas[0]->payment_installment_type == "InstallmentPayment"){
        $CourseWatchNextData = getData('payment_installment',['next_install_date','paid_install_no'],['user_id'=>auth()->user()->id,'course_id'=>$CourseId,'student_course_master_id'=> $CourseWatchDatas[0]->id,'paid_install_status'=>'0'],'1','id','DESC');

        $CourseWatchNextDataAmount = getData('payment_installment',['next_install_date','paid_install_amount'],['user_id'=>auth()->user()->id,'course_id'=>$CourseId,'student_course_master_id'=> $CourseWatchDatas[0]->id,'paid_install_status'=>'0'],'','','id','DESC');
                                ...
                                <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                    ...
                                    <div class="simplebar-content student-award-panel-scrollbar" style="padding: 0px;">
                                         @php
                                                ...
                                                $CourseWatchData = getData('student_course_master',['watch_content_id','course_progress','id'],['user_id'=>auth()->user()->id,'course_id'=>$course_id],'','id','DESC');
                                                                            ...
                                                                            @foreach ($section_manage['course_video'] as $video)
                                                                                ...
                                                                                id="course-project-tab" data-bs-toggle="pill"  href="#course-project"  onclick="videoDisplay('{{ $video['bn_video_url_id'] }}','{{$video['id']}}','{{base64_encode($masterdata['coursemodules'][0]['id'])}}')"  role="tab" aria-controls="course-project" aria-selected="false">
                                                                                    <div class="d-flex align-items-center">
                                                                                        <span class="icon-shape text-primary icon-sm rounded-circle me-2 icon_bg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
            ...
            <div class="d-flex justify-content-around" style="padding: 0px">
                ...
                @php $total_full_price = $CourseMaster[0]->course_old_price - ($CourseMaster[0]->course_old_price - $CourseMaster[0]->course_final_price) ; 
                @endphp
                ...
                <input type="hidden" class="form-control student_course_master_id" name="student_course_master_id" value="{{ !empty($CourseWatchData) ? base64_encode($CourseWatchData[0]->id) : ''}}">
