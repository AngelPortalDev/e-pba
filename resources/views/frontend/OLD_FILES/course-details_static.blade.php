                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-grid"> 
                                ...
                                <form action="{{ route('checkout') }}" method="post">
                                    ...
                                    <input type="hidden" class="form-control overall_total" name="overall_total" value="{{base64_encode('100')}}">
                                ...
                                <a href="#" class="btn btn-outline-primary addtocart" id="addtocart" data-course-id="{{base64_encode($CourseId)}}" data-action="{{base64_encode('add')}}"><i class="fe fe-shopping-cart text-primary"></i> Add to Cart</a>
                            </div>
                        </div>
                    </div>
                    <!-- Card -->
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <img src="{{ asset('frontend/images/team/italo-esposito-photo.jpg')}}" alt="avatar" class="rounded-circle avatar-xl">
