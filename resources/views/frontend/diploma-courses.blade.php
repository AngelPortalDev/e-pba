        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="text-white mb-1 display-4 color-green"> {{__('static.Diploma')}} {{__('static.course')}}</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-lg-8">
            ...
            <div class="row row-gap-3">
                {{-- <div class="col-md-4 col-sm-6 col-lg-3"> --}}
                    @php
                    $diploma =
                    getData('course_master',['course_title','id','selling_price','ects','course_final_price','course_old_price','course_thumbnail_file','status','temp_count','category_id'],['category_id'=>'3'],'',DB::raw('IFNULL(published_on, "NULL")'),'asc');
                    $allowedRoles = ['institute', 'superadmin', 'admin', 'instructor', 'sub-instructor'];
                    $categoryDiploma = __('static.Diploma');
                    @endphp

                    @include('frontend.full-courses', ['courses' => $diploma,'allowedRoles'=>$allowedRoles,'Category'=>$categoryDiploma])
