            ...
            @php
                    ...
                    foreach ($questions as $value) {
                        ...
                        if($attempt_exam == base64_encode('1')){
                            ...
                            $totalObtain += isset($value['mock_anwers'][1]['marks_given']) && !empty($value['mock_anwers'][1]['marks_given']) ?  $value['mock_anwers'][1]['marks_given'] : 0;
                        }
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-12 mb-5">
                                            ...
                                            <div class="color-blue d-flex align-items-end">
                                                <div class="col-md-4 col-lg-2 col-sm-12">
                                                   ...
                                                   <h5 class="me-3 ">Marks: <span>(Out of {{ isset($item['marks']) ? $item['marks'] : ''}})</span></h5>
                                                    <input type="number" name="marks[]" class="form-control marks-input" placeholder="Give Marks" max="{{ isset($item['marks']) ? $item['marks'] : 0}}" value="{{ isset($item['mock_anwers'][0]['marks_given']) ? $item['mock_anwers'][0]['marks_given'] : ''}}"  required disabled>
                                                    </div>
                                                  @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-3 col-12">
                                            @if (isset($item['file_type']) && !empty($item['file_type']) && $item['file_type'] === "1")
                                             @if (isset($item['mock_anwers'][1]['answer_file_url']) && !empty($item['mock_anwers'][1]['answer_file_url']) && Storage::exists($item['mock_anwers'][1]['answer_file_url']))
                                            <div class="d-flex justify-content-center align-items-center rounded border-white border rounded-3 bg-cover" style="background-image:url({{asset('frontend/images/document-thumbnail-01.png') }});height:155px;">
                                                <a class="icon-shape rounded-circle btn-play icon-xl bg-blue" href="javascript:void(0)" onclick="openPdf('{{$item['mock_anwers'][1]['answer_file_url']}}')">
                                                    <i class="bi color-green fs-4 fw-bold bi-eye"></i>
                                                </a>
                                            </div>
                                             @else
                                                ...
                                                @endif
                                            @elseif(isset($item['file_type']) && !empty($item['file_type']) && $item['file_type'] === "2")
                                                @if (isset($item['mock_anwers'][1]['answer_file_url']) && !empty($item['mock_anwers'][1]['answer_file_url']))
                                                    <div class="d-flex justify-content-center align-items-center rounded border-white border rounded-3 bg-cover" style="background-image:url({{asset('frontend/images/course/mock-interview-thumbnail-01.png') }});height:155px;">
                                                        <a class="glightbox icon-shape rounded-circle btn-play icon-xl" href="https://iframe.mediadelivery.net/embed/{{env('Student_LIBRARY_ID')}}/{{  $item['mock_anwers'][1]['answer_file_url'] }}">
                                                            <i class="fe fe-play"></i>
                                                        </a>
                                                    </div>
                                                @else
                                        ...
                                        <div class="col-md-12 col-12 mt-3">
                                            <div class="color-blue d-flex align-items-end">
                                                <div class="col-md-4 col-lg-2 col-sm-12">
                                                   @if(isset($item['marks']) && $item['marks'] > 0) 
                                                   <h5 class="me-3 ">Marks: <span>(Out of {{ isset($item['marks']) ? $item['marks'] : ''}})</span></h5>
                                                    <input type="number" name="marks[]" class="form-control marks-input" placeholder="Give Marks" max="{{ isset($item['marks']) ? $item['marks'] : 0}}" value="{{ isset($item['mock_anwers'][1]['marks_given']) ? $item['mock_anwers'][1]['marks_given'] : ''}}"  required disabled>
                                                    </div>
                                                  @endif
                                            </div>
                                        </div>
