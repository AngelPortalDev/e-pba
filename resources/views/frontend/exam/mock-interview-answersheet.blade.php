                                ...
                                <div class="col-md-12 mb-5">
                                    <div class="">
                                        <h5 class="color-blue mb-0 mock_interview_ementor_question">
                                            <span class="text-inherit mockquestionstyle">Question {{ $num }} </span>
                                            @if(isset($item['marks']) && $item['marks'] > 0) 
                                                <p class="d-inline mb-0 text-inherit mockquestionstyle" style="display: inline; margin: 0; float: inline-end;">[{{ isset($item['marks']) ? $item['marks'] : 0 }} Marks]</p>
                                            @endif
