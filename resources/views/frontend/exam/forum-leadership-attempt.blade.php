            ...
            <div class="container">
                @php
                    ...
                    if($attempt_exam == base64_encode('1')){
                        ...
                        $discordExamAnswer = $exam['discord_exam_answers'][1];
                    }
                                            ...
                                            <div class="col-md-12 col-12 mt-3 mb-3">
                                                <div class="color-blue d-flex align-items-end">
                                                    <div class="col-md-4 col-lg-2">
                                                        ...
                                                        <input type="number" name="mark" id="mark" class="form-control" placeholder="Give Marks" value="{{ isset($discordExamAnswer['marks_given']) ? $discordExamAnswer['marks_given'] : ''}}" disabled>
                                                    </div>
                                                </div>
                                            </div>
