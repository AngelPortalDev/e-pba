            ...
            <div class="container">
                @php
                    ...
                    if($attempt_exam == base64_encode('1')){
                        ...
                        $peerReviewExamAnswer = $exam['peer_review_exam_answers'][1];     
                    }
                                                ...
                                                <div class="col-md-12 col-12 mt-2 mb-3">
                                                    <div class="color-blue d-flex align-items-end">
                                                        <div class="col-md-12 col-lg-2">
                                                            ...
                                                            <input type="number" name="mark" id="mark" class="form-control" placeholder="Give Marks" value="{{ isset($peerReviewExamAnswer['marks_given']) ? $peerReviewExamAnswer['marks_given'] : ''}}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
