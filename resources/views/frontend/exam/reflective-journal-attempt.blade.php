            ...
            @php
                ...
                foreach ($reflectiveJournalQuestion as $value) {
                    ...
                    if($attempt_exam == base64_encode('1')){
                        ...
                        $totalObtain += isset($value['reflective_journal_answers'][1]['marks_given']) && !empty($value['reflective_journal_answers'][1]['marks_given']) ?  $value['reflective_journal_answers'][1]['marks_given'] : 0;
                    }
                }
            @endphp
                                ...
                                <form id="examMarksForm">
                                    ...
                                    @foreach($reflectiveJournalQuestion as $key => $reflectiveJournal)
                                        <div class="col-md-12 mb-5">
                                            ...
                                            @else
                                            <p style="white-space: pre-line">{!! isset($reflectiveJournal['reflective_journal_answers'][1]['answer']) ? html_entity_decode($reflectiveJournal['reflective_journal_answers'][1]['answer']) : '--Not Attempted--' !!}</p>
                                            ...
                                            <div class="color-blue d-flex align-items-end mt-3">
                                                <div class="col-md-4 col-lg-2 col-sm-12">
                                                    ...
                                                    <input type="number" name="marks[]" class="form-control marks-input" placeholder="Give Marks" 
                                                        max="{{ isset($reflectiveJournal['marks']) ? $reflectiveJournal['marks'] : 0 }}" 
                                                        value="{{ isset($reflectiveJournal['reflective_journal_answers'][1]['marks_given']) ? $reflectiveJournal['reflective_journal_answers'][1]['marks_given'] : '0' }}" 
                                                        required disabled>
                                                </div>
                                            </div>
                                            @endif
