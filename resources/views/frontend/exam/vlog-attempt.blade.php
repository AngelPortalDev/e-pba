            ...
            @php
                ...
                foreach ($questions as $value) {
                    ...
                    if($attempt_exam == base64_encode('1')){
                        ...
                        $totalObtain += isset($value['vlog_anwers'][1]['marks_given']) && !empty($value['vlog_anwers'][1]['marks_given']) ?  $value['vlog_anwers'][1]['marks_given'] : 0;
                    }
                                    ...
                                    <div class="col-md-12 mb-5">
                                            ...
                                            <div class="col-md-12 col-12 mt-3 mb-3">
                                                <div class="color-blue d-flex align-items-end">
                                                    <div class="col-md-4 col-lg-2">
                                                        ...
                                                        <input type="number" name="marks[]" class="form-control" placeholder="Give Marks" value="{{ isset($questions[0]['vlog_anwers'][0]['marks_given']) ? $questions[0]['vlog_anwers'][0]['marks_given'] : ''}}" required disabled >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-3 col-12">
                                                ...
                                                @if (isset($questions[0]['vlog_anwers'][1]['answer_file_url']) && !empty($questions[0]['vlog_anwers'][1]['answer_file_url']))
                                                    <div class="d-flex justify-content-center align-items-center rounded border-white border rounded-3 bg-cover" style="background-image:url({{asset('frontend/images/course/mock-interview-thumbnail-01.png') }});height:155px;">
                                                        <a class="glightbox icon-shape rounded-circle btn-play icon-xl" href="https://iframe.mediadelivery.net/embed/{{env('Student_LIBRARY_ID')}}/{{  $questions[0]['vlog_anwers'][1]['answer_file_url'] }}">
                                                            <i class="fe fe-play"></i>
                                                        </a>
                                                    </div>
                                                @else
                                            ...
                                            <div class="col-md-12 col-12 mt-3 mb-3">
                                                <div class="color-blue d-flex align-items-end">
                                                    <div class="col-md-4 col-lg-2">
                                                        <h5 class="me-3 ">Marks: <span>(Out of {{$totalMarks}})</span></h5>
                                                        <input type="number" name="marks[]" class="form-control" placeholder="Give Marks" value="{{ isset($questions[0]['vlog_anwers'][1]['marks_given']) ? $questions[0]['vlog_anwers'][1]['marks_given'] : ''}}" required disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
